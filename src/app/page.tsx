        ...
        <div className="relative h-[80vh] min-h-[540px] max-h-[820px] w-full bg-[#2D3142] rounded-[24px] md:rounded-[36px] overflow-hidden flex flex-col justify-end shadow-soft border border-[#ADACB5]/40">
          ...
          <div className="relative z-10 p-6 md:p-14 flex flex-col items-start w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <Link
                href="/shop"
                className="bg-[#D8D5DB] text-[#2D3142] px-8 min-h-[50px] md:min-h-[54px] rounded-full font-black tracking-[0.2em] uppercase text-xs flex items-center justify-center group hover:bg-white active:scale-98 transition-all shadow-sm w-full sm:w-auto"
              >
      ...
      <section className="w-full pb-12 md:pb-18 overflow-hidden">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar pl-4 md:pl-8 gap-2.5 md:gap-4 pb-2">
          {[
            ...
            <div
              key={i}
              className="relative flex-none w-[44vw] md:w-[20vw] aspect-square snap-start rounded-[20px] md:rounded-[24px] overflow-hidden bg-[#2D3142] group shadow-card border border-[#ADACB5]/40"
            >
              <Image
                src={img}
              ...
              />
              <div className="absolute top-2.5 right-2.5 w-8 h-8 bg-white/85 backdrop-blur-md rounded-full flex items-center justify-center text-[#2D3142] opacity-0 group-hover:opacity-100 transition-opacity shadow-sm">
